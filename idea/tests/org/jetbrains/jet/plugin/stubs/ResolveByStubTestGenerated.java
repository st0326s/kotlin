...
@InnerTestClasses({ResolveByStubTestGenerated.CompiledKotlin.class, ResolveByStubTestGenerated.CompiledKotlinCompilerOnly.class})
...
public class ResolveByStubTestGenerated extends AbstractResolveByStubTest {
    ...
    @RunWith(JUnit3RunnerWithInners.class)
    public static class CompiledKotlin extends AbstractResolveByStubTest {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @InnerTestClasses({CompiledKotlinCompilerOnly.Annotations.class})
    @RunWith(JUnit3RunnerWithInners.class)
    public static class CompiledKotlinCompilerOnly extends AbstractResolveByStubTest {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @InnerTestClasses({Annotations.Deprecated.class, Annotations.Inline.class})
        @RunWith(JUnit3RunnerWithInners.class)
        public static class Annotations extends AbstractResolveByStubTest {
            public void testAllFilesPresentInAnnotations() throws Exception {
            ...
            @TestDataPath("$PROJECT_ROOT")
            @RunWith(JUnit3RunnerWithInners.class)
            public static class Deprecated extends AbstractResolveByStubTest {

...
public abstract class ElementResolver {
    ...
    private void codeFragmentAdditionalResolve(
        ...
        else if (contextElement instanceof JetBlockExpression && contextElement.getParent() instanceof JetDeclarationWithBody) {
            JetBlockExpression body = (JetBlockExpression) ((JetDeclarationWithBody) contextElement.getParent()).getBodyExpression();
            if (body == null) return;

            JetElement newContextElement = KotlinPackage.lastOrNull(body.getStatements());
